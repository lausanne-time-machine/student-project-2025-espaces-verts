...
```js
const geojson = FileAttachment("./data/Berney_espaces_verts_macro.geojson").json()
```
...
```js
const registre = FileAttachment("./data/Berney_macro_classes.csv").csv()
```
